 ...
 */
export class StockListDataSource extends DataSource<StockItem> {
   paginator: MatPaginator | undefined;
   sort: MatSort | undefined;

   readonly data = signal<StockItem[]>([]);
    ...
    */
   private getPagedData(data: StockItem[]): StockItem[] {
      if (this.paginator) {
    ...
    * this would be replaced by requesting the appropriate data from the server.
    */
   private getSortedData(data: StockItem[]): StockItem[] {
